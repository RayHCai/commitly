...
import { createLink, completeLink, getShellLinks, getUserLinks, createGeneralLink, completeGeneralLink, forceCreateGeneralLink } from "../controllers/link.controller.js";
...
linkRoutes.post("/general/create", authenticate, forceCreateGeneralLink);
